...
public class EasyLipoSQLite extends SQLiteOpenHelper {
    ...
    private static EasyLipoSQLite instance = null;
    ...
    public class Commands {
        ...
        public static final String COL_COMMAND_METHOD = "TYPE";
        ...
        public static final String COL_COMMAND_BATTERY_LOCAL_ID = "BATTERY_LOCAL_ID";
        ...
        private static final String CREATE_TABLE_COMMANDS = "CREATE TABLE " + TABLE_COMMANDS + " ("
                ...
                + COL_COMMAND_METHOD + " TEXT NOT NULL,"
                + COL_COMMAND_ROUTE + " TEXT NOT NULL, "
                + COL_COMMAND_JSON + " TEXT, "
                + COL_COMMAND_NAME + " TEXT NOT NULL, "
                + COL_COMMAND_BATTERY_LOCAL_ID + " INTEGER "
                + ");";

    }

    private EasyLipoSQLite(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    public static EasyLipoSQLite getInstance(Context context) {
        if (instance == null)
            instance = new EasyLipoSQLite(context);
        return instance;
    }
